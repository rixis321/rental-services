...
import com.example.rentalservices.payload.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(RentalServiceApiException.class)
    public ResponseEntity<ErrorDetails> handleCarRepairShopApiException(RentalServiceApiException exception, WebRequest webRequest){
        ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
